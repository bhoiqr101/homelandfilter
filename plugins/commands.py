...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('♻️  ᴘʟᴇᴀꜱᴇ ꜱʜᴀʀᴇ  ♻️', url=f"https://telegram.me/share/url?url=telegram.me/gdhubnation"),
            ]
            ]
    ...
    if data.startswith("sendfiles"):
        ...
        if (
            ...
            [
                InlineKeyboardButton('⁉️  ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ  ⁉️', url="https://t.me/gdhubnation_chat")
            ]
            ]
        else:
...
async def shortlink(bot, message):
    btn = [[
        InlineKeyboardButton(text="Contact Admin", url="https://t.me/GDHubAdminbot"),
        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="https://telegram.me/gdhubnation")
        ],[
        InlineKeyboardButton(text="JOIN ALL OUR CHANNEL", url="https://t.me/addlist/o7RyNlw6UBw0NTg1")
    ]]
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_photo(photo='https://telegra.ph/file/bf6ffdff12f81d75b46f1.jpg', caption="<b>──────「 <a href='https://telegram.dog/gdhubnation'>WELCOME</a> 」──────\n\n➥ You are in a Premium Group & Channel of Telegram.</b>", reply_markup=InlineKeyboardMarkup(btn))
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
...
async def removetutorial(bot, message):
    btn = [[
        ...
        InlineKeyboardButton(text="ꜱᴜʙꜱᴄʀɪʙᴇ  ᴍʏ  ᴄʜᴀɴɴᴇʟ", url="https://t.me/GDHubnation")
    ]]
    userid = message.from_user.id if message.from_user else None
    if not userid:
